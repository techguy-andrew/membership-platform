...
const featuredResources = [
  {
    ...
    description: "Comprehensive business plan template with financial projections, market analysis, and strategic planning sections.",
    type: "Template",
    format: "PDF + Excel",
    pages: 25,
    downloads: 1243,
  ...
  },
  {
    ...
    description: "Step-by-step guide to optimizing your sales funnel for maximum conversion rates and revenue growth.",
    type: "Guide",
    format: "PDF",
    pages: 18,
    downloads: 987,
  ...
  },
  {
    ...
    description: "Structured worksheet for evaluating team performance, setting goals, and tracking progress over time.",
    type: "Worksheet",
    format: "Excel + PDF",
    pages: 8,
    downloads: 756,
  ...
  },
  {
    ...
    description: "Essential checklist to assess and improve your business's financial health and cash flow management.",
    type: "Checklist",
    format: "PDF",
    pages: 6,
    downloads: 634,
  ...
  },
  {
    ...
    description: "Visual canvas template for developing comprehensive marketing strategies and campaigns.",
    type: "Template",
  ...
  },
  {
    ...
    description: "Complete framework for developing leadership skills with exercises, assessments, and action plans.",
    type: "Guide",
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Download templates, guides, worksheets, and tools to accelerate your business growth
          </p>
        </div>
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        {resource.isNew && <Badge className="bg-green-600">New</Badge>}
                      </div>
              ...
              {recentlyAdded.map((resource, index) => (
                <div key={index} className="flex items-start gap-3 p-3 hover:bg-muted/50 rounded-lg cursor-pointer">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="text-xs text-muted-foreground">{resource.dateAdded}</div>
                  </div>
                </div>
              ))}
            </CardContent>
